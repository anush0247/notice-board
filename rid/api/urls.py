...
from .views import basic, university_info, contact_info, profile_pic, summary
from .views import education, areas, skills, roles, achievemetns, experiences
...
urlpatterns = patterns('',
    ...
    url(r'achievemetns/', achievemetns, name="api_achievements_info"),
